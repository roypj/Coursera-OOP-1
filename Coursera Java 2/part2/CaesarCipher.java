...
//     System.out.println(key);
    ...
    public void testMultiKey(){
       // String ecr = encryptTwoKeys("At noon be in the conference room with your hat on for a surprise party. YELL LOUD!",8,21); 
    //System.out.println(ecr);
    String ecr ="Hfs cpwewloj loks cd Hoto kyg Cyy.";
    System.out.println(encryptTwoKeys(ecr,12,2));
    }
}
